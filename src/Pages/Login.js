...
import Doctor from '../Images/svg-1.svg'
import { Link } from 'react-router-dom'

export default function Login() {
    return (
        <div className='h-screen w-screen overflow-hidden'>
            <div className='bg-sky-100 w-full h-[60vh] relative'>

                {/* navbar */}
                <div className='flex justify-between py-3 px-5'>
                    <span className='cursor-pointer text-4xl'><IoLogoCodepen className='inline text-sky-400' /></span>
                    <p className='text-xs my-auto'><CiCircleQuestion className='inline text-2xl mb-1' /> Pusat Bantuan</p>
                </div>

                {/* grid 1  */}
                <div className='p-20 ml-10 z-10'>
                    <h1 className='text-4xl font-[500] leading-normal'>Selamat Datang di Solusi <br />Perangkat Lunak Farmasi</h1>
                    <p className='text-2xl'>Sistem Manajemen Apotek Online</p>
                </div>
                <div className='absolute bottom-5 z-10 right-0'>
                    <img src={Doctor} width={"500px"} alt="bg-login" />
                ...
                <div className='absolute w-full -bottom-10'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#BAE6FF" fill-opacity="1" d="M0,192L60,176C120,160,240,128,360,149.3C480,171,600,245,720,229.3C840,213,960,107,1080,90.7C1200,75,1320,149,1380,186.7L1440,224L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path></svg>
                </div>
            </div>

            {/* grid2 */}
            <div className='bg-sky-200 w-full h-[40vh] text-center relative'>
                <h1 className='text-2xl font-bold mb-4'>Silahkan masuk kedalam akun anda dan kelola apotek anda</h1>
                <div className='w-80 mx-auto'>
                    <form>
                        ...
                        <Link to='/Dashboard'>
                            <button className='mt-2 py-1 bg-sky-600 w-full rounded-md text-gray-200 text-[500] hover:bg-sky-700'>Masuk</button>
                        </Link>
